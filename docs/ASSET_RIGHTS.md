...
| `public/audio/clicks/ESM_GW_foley_one_shot_gun_handling_trigger_22_rifle_click.wav` | Filename indicates Epic Stock Media. | Locate the purchase/download record and confirm the applicable web-game or application license. |
| `public/audio/clicks/ESM_Builder_Game_Switch_3_Click_Button_Tab_Select_Particle.wav` | Filename indicates Epic Stock Media. | Locate the purchase/download record and confirm the applicable web-game or application license. |
| `public/audio/clicks/ESM_BG_Cinematic_FX_ui_button_one_shot_digital_mouse_down_click.wav` | Filename indicates Epic Stock Media. | Locate the purchase/download record and confirm the applicable web-game or application license. |
| `public/audio/clicks/ESM_Perfect_Clean_App_Button_Click_2_Organic_Simple_Click.wav` | Filename indicates Epic Stock Media. | Locate the purchase/download record and confirm the applicable web-game or application license. |
